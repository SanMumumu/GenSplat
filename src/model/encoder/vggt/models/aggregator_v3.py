...
from src.model.encoder.vggt.layers.vision_transformer_v3 import vit_large
...
class Aggregator_v3(nn.Module):
    def __init__(
        ...
        proj_bias=True,
        ffn_bias=True,
        patch_embed="dinov3_vitl16_pretrain_lvd1689m",
    ...
    def __build_patch_embed__(
        ...
        if "conv" in patch_embed:
            ...
            vit_models = {"dinov3_vitl16_pretrain_lvd1689m": vit_large}
